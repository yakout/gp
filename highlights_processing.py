...
class Merger():
    ...
    def get_points(highlights_dict, component_confidence):
        ...
        for component, highlights in highlights_dict.items():
            ...
            for highlight in highlights:
                # Add start point with Highlight=True
                points.append((highlight.start_index, True,
                               component_score * highlight.score))
                # Add end point with Highlight=False
                points.append(
                    (highlight.end_index, False, component_score * highlight.score))
        points.sort()
        return points
    ...
    def merge(highlights_dict, component_confidence):
        ...
        """
        return highlights_dict['sound'] # temp
        ...
        for point in points:
            ...
            # 1. index: start index
            # 2. is_highlight: True/False
            # 3. score: highlight score (component confidence * highlight score)
            index, is_highlight, score = point[0], point[1], point[2]
            # print("index {}, is_highlight {}, score {}".format(index, is_highlight, score))
            ...
            current_score += score if is_highlight else -score
