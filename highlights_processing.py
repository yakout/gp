...
class Summarizer():
	...
	def summarize(chunk_highlights_dict, duration_limit):
		...
		for chunk_position, highlights in summarized_highlights.items():
			summarized_highlights[chunk_position] = sorted(highlights, key=lambda highlight: highlight.start_index)   # sort by start
			print("#summarize: sorted highlights {}".format(highlights))
